...
<div class="page">
    ...
    <div class="wrapper">
        ...
        <div class="contents">
            ...
            <h1>欢迎访问我们的首页！</h1>
            <p>一段文本iiiiiiiiiiiiiiiiiiiiiii。</p>
            <p>一段文本。</p>
            <?php include 'styles/hahah.php'; ?>
            ...
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
                ...
                if (isset($_GET['pid'])) {
                    if (isset($_SESSION['uid'])) {
                        ...
                        $nnnn = validateInput($_GET['pid']);
                        print  $nnnn;
                        $stmt->bind_param("ii", $_SESSION['uid'], $_GET['pid']);
                ...
                if (isset($_GET['ppid'])) {
                    if (isset($_SESSION['uid'])) {
                        $stmt = $con->prepare("INSERT INTO tbcollection (uid, ppid) VALUES (?, ?)");
                        $nnnn = validateInput($_GET['ppid']);
                        print  $nnnn;
                        $stmt->bind_param("ii", $_SESSION['uid'], $_GET['ppid']);

                        if ($stmt->execute()) {
                            echo "Item added to the collection successfully!<br/>";
                        } else {
                            echo "Error add item to the cart<br/>";
                            printf("Error: %s.\n", $stmt->error);
                        }
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td width=\"100\"><a href=\"index.php?ppid=" . $row['pid'] . "&page=$page\">Add To collection</a></td>";
                        echo "</tr>";
                    }
                }
