...
if (isset($_SESSION['uid'])) {
    $site_title = "Demo Shopping Cartvvvvv" . $_SESSION['username'];

    $site_footer = "Demo Shopping ===Cart " . date("Y") . " &copy; Rasan Samarasinghe";
} else {
    $site_title = "Demo Shopping Cartvvvvv未登录";
...
function mainMenu()
{
    if (isset($_SESSION['uid'])) {
        ...
        echo "<li><a href=\"address.php\">address</a></li>";
        echo "<li><a href=\"newadd.php\">newadd</a></li>";
...
function henllon($oo)
{
    $oo = "Your order on Demo Shopping Cart confirmed successfully. \n\n Thank you";
    echo $oo;
}
